...
export const InsertarPedido = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost/react-proyecto/src/php/insertar-pedido.php', {
        method: 'POST',
        headers: {
    ...
    <div className="w3-container w3-margin-top">
      <div className="w3-card-4 w3-light-grey w3-padding-large">
        ...
        <form onSubmit={handleSubmit} className="w3-container">
          ...
          <button type="submit" className="w3-button w3-blue w3-margin-top">Insertar</button>
        </form>
