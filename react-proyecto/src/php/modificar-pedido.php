...
try {
    ...
    $sentencia = $conex->prepare("UPDATE PEDIDO 
    SET FECHAPED_PED=:FECHAPED_PED, ID_CAL=:ID_CAL, RFC_PROV=:RFC_PROV, CANT_PED=:CANT_PED, 
    FECHASURT_PED=:FECHASURT_PED, COSTO_PED=:COSTO_PED 
    WHERE ID_PED=:ID_PED;");
