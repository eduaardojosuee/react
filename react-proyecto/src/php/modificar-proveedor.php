...
try {
    ...
    $sentencia = $conex->prepare("UPDATE PROVEEDORES 
    SET NOMBRE_PROV=:NOMBRE_PROV, TEL_PROV=:TEL_PROV, DIR_PROV=:DIR_PROV, EMAIL_PROV=:EMAIL_PROV
    WHERE RFC_PROV=:RFC_PROV;");
